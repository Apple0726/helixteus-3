...
const DATE:String = "4 Apr 2026"
const VERSION:String = "v0.30.2"
const COMPATIBLE_SAVES = ["v0.30", "v0.30.1"]
...
var overlay_data = {	"galaxy":{"overlay":0, "visible":false, "custom_values":[{"left":2, "right":30, "modified":false}, {"left":1, "right":5, "modified":false}, null, null, null, {"left":0.5, "right":15, "modified":false}, {"left":250, "right":100000, "modified":false}, {"left":1, "right":1, "modified":false}, {"left":1, "right":1, "modified":false}, null]},
						"cluster":{"overlay":0, "visible":false, "custom_values":[{"left":200, "right":10000, "modified":false}, null, null, null, {"left":1, "right":100, "modified":false}, {"left":0.2, "right":5, "modified":false}, {"left":0.8, "right":1.2, "modified":false}, null, null]},
}
				...
				if not is_starting_solar_system:
					while randf() < 0.25:
						...
						if additional_passive_ability not in HX_data.passive_abilities:
							...
							HX_data.XP *= 0.6 * len(HX_data.passive_abilities)
...
func add_right_click_menu(items:Array, on_close_no_action_callable = null):
	if is_instance_valid(right_click_menu):
		right_click_menu.queue_free()
	right_click_menu = preload("res://Scenes/RightClickMenu.tscn").instantiate()
	right_click_menu.items = items
	right_click_menu.position = mouse_pos
	if on_close_no_action_callable:
		right_click_menu.on_close_no_action.connect(on_close_no_action_callable)
	hide_tooltip()
